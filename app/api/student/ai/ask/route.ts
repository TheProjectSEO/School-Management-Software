...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use student.studentId directly from JWT auth result
    ...
    // Fetch comprehensive student context using studentId from JWT auth
    const studentContext = await getStudentContext(supabase, studentId, {
