...
// Maps to types accepted by DB constraint: true_false, short_answer, essay, fill_in_blank, matching
function normalizeQuestionType(type: string): string | null {
  const normalized = type.toLowerCase().replace(/[\s_-]+/g, "_");

  const typeMap: Record<string, string> = {
    // Map all multiple choice variants to true_false (DB constraint doesn't include multiple_choice)
    "multiple_choice": "true_false",
    "multiple_choice_single": "true_false",
    "multiplechoice": "true_false",
    "mc": "true_false",
    "single": "true_false",

    "multiple_choice_multi": "true_false",
    "multi_select": "true_false",
    "multiselect": "true_false",
    "multi": "true_false",
    "checkbox": "true_false",
