...
import type { DirectMessage } from "@/lib/dal/types";
...
export function MessageNotificationProvider({
    ...
    toast.message(displayName, {
      ...
      action: {
        ...
        onClick: () => {
          ...
          window.location.href = `/messages?partner=${message.from_profile_id}`;
        },
      },
      duration: 5000,
    });
  ...
  }, [profileId, refreshUnreadCount, showNewMessageToast]);
