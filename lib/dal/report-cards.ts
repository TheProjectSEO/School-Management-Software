 ...
 * @param studentId - Optional student ID for authorization (ensures the report card belongs to this student)
...
export async function getReportCard(
  ...
  try {
    ...
    // If studentId is provided, also filter by student for authorization
    if (studentId) {
...
// ============================================================================
// STUDENT-FOCUSED QUERY FUNCTIONS
// ============================================================================
